...
const viewDetail= (id)=>{
    ...
    console.log(order)
    document.querySelector("#id_order_update").setAttribute('value', id)
    console.log(id, document.querySelector("#id_order_update").value )
    ...
    document.querySelector("#orderDetailsModal span.show_detail_orders_leadtime").innerHTML = order.leadTime
